...
public class CarWiseMessages {
    ...
    public static final String carAlreadyExists = car + alreadyExists;
    ...
    public static final String carCreated = car + created + successfully;
    ...
    public static final String carsFetched = car + plural + fetched + successfully;
